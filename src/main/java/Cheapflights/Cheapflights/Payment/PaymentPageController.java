...
import Cheapflights.Cheapflights.Miscellaneous.SceneSwitcher;
import Cheapflights.Cheapflights.*;
import Cheapflights.Cheapflights.Booking.BookingConfirmationController;
import Cheapflights.Cheapflights.File.ReadExternalConfig;
import Cheapflights.Cheapflights.Flight.Flight;
import Cheapflights.Cheapflights.Passenger.Passenger;
import Cheapflights.Cheapflights.Passenger.PassengersController;
import Cheapflights.Cheapflights.User.User;
...
public class PaymentPageController implements Initializable{
    ...
    // Reading the constant image paths and the colors from an external configuration file (Cheapflights.properties) using class ReadExternalConfiguration
    ...
    public void onPayButtonClick(MouseEvent mouseEvent){
        ...
        if(currentPaymentMethod.equals("card")){
            ...
            if(!cardOwnerNameTextField.getText().matches(CARD_NAME_PATTERN)){
                cardNameOrPaypalEmailError.setText("Please don't leave this field empty or enter a valid name with no special characters (Ex: cheapflights)");
            ...
            if(!paypalEmail.matches(EMAIL_PATTERN)){
                cardNameOrPaypalEmailError.setText("Please don't leave this field empty or enter a valid email (Ex: Cheapflights@gmail.com)");
                cardNameOrPaypalEmailError.setVisible(true);
