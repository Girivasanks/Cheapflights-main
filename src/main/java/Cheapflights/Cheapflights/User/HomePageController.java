...
import Cheapflights.Cheapflights.Main;
...
public class HomePageController {
    ...
    {
        fxmlLoader = new FXMLLoader(Main.class.getResource("/Cheapflights/Cheapflights/HomePage/HomePage.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
        stage.setTitle("Cheapflights!");
    ...
    public void homePageOnSignUp(ActionEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(HomePageController.class.getResource("/Cheapflights/Cheapflights/HomePage/HomePageSignUp.fxml"));
    ...
    public void homePageOnSignIn(ActionEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(HomePageController.class.getResource("/Cheapflights/Cheapflights/HomePage/HomePageSignIn.fxml"));
    ...
    public void internalOnSignUpButton(ActionEvent e) {
        ...
        if(email == null || !email.matches("\\w+@\\w+\\.com")) {
            emailVaidatorLabel.setText("Incorrect email, follow this format [paul-walker@gmail.com]");
